...
int main() {
   ...
   PData person1{ "Brady", "100-0042 Science Rd.", "Arequipa", "0X", 10101 };
   PData person2{ "Camila", "57th St.", "New New York", "NY", 98765 };
   ...
   for ( Package* packagePtr : packages ) {
      cout << typeid( *packagePtr ).name() << ":\n" << packagePtr->getLabels()
         << "Costo de envio: $" << packagePtr->calculateCost() << '\n' << endl;
   ...
   cout << "El costo total del envio es: " << total << endl;
